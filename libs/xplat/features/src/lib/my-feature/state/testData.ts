  ...
  rating: [
    {
      ...
      rate_adjustments: [
        ...
        {
          factor_title: [],
          rate_factors: [{ _id: "23", title: 'Limit Selection 1000000' }],
          rate_type: 'Factor',
          rate: 1.1,
          rate_application: 'On Policy',
        ...
        {
          factor_title: [],
          rate_factors: [{ _id: "12", title: 'Deductible Selection 1500' }],
          rate_type: 'Factor',
          rate: 1.15,
          rate_application: 'On Policy',
        ...
        {
          factor_title: [],
          rate_factors: [{ _id: "20", title: 'Rate minimum applied 10000' }],
          rate_type: 'Flat Rate',
          rate: 10000,
          rate_application: 'On Policy',
